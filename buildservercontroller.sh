...
g++ ./Source/Database.cpp -c 
g++ -o server server_main.o ServerController.o Menu.o Account.o Submission.o Phase.o File.o Database.o common.o Conference.o Review.o -lsfml-network -lsfml-system -Wall
rm *.o
